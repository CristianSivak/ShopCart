...
function actualizarCarritoUI(){
    fetch('http://localhost/curso/58-60.%20carrito/tutorial/api/carrito/api-carrito.php?action=mostrar')
...
function removeItemFromCarrito(id){
    fetch('http://localhost/curso/58-60.%20carrito/tutorial/api/carrito/api-carrito.php?action=remove&id=' + id)
    .then(res => res.json())
    .then(data =>{
...
function addItemToCarrito(id){
    fetch('http://localhost/curso/58-60.%20carrito/tutorial/api/carrito/api-carrito.php?action=add&id=' + id)
    .then(res => res.json())
    .then(data =>{
        console.log(data.status);
        actualizarCarritoUI();
